...
function CitizenDashboard() {
  ...
  }, [token, navigate, fetchUserIssues, user.id]);
    ...
    <div className="cd-root">
      ...
      <main className="cd-main">
        ...
        <div className="cd-topbar">
          <div>
            <h1 className="cd-title">My Complaints</h1>
            <p className="cd-subtitle">Track the status of all your reported civic issues</p>
          </div>
        ...
        <div className="cd-stats">
          <div className="cd-stat-card cd-stat-total">
            ...
            <div className="cd-stat-label">Total Complaints</div>
          </div>
        ...
        {loading ? (
          ...
          <div className="cd-empty">
            ...
            <p>{filter === 'all' ? "You haven't reported any issues yet." : `No ${STATUS_META[filter]?.label || filter} complaints.`}</p>
            {filter === 'all' && (
              <button className="cd-report-btn" onClick={() => navigate('/report-issue')}>
